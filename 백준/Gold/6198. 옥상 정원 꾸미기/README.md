...
입력값이 최대 80000이므로 _O(n)_ 시간복잡도로 풀이

`∑ n번째 건물이 볼 수 있는 건물의 수 = ∑ n번째 건물을 볼 수 있는 건물의 수`

후자의 방식으로 풀이하기 위해

1. 현재 건물 높이 이상인 이전 건물 수 세기
2. 현재 건물 높이 미만의 건물을 만나면, 해당 건물 스택에서 제거
3. 1회 순환 후, 남은 건물의 수 = 현재 건물을 볼 수 있는 건물의 수
4. 현재 건물 스택에 추가

### 제출 일자

2024년 10월 24일 18:35:43
