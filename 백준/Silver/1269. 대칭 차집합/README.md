...
첫 번째 집합에서는 add만, 두 번째 집합에서는 **contains** 여부로 **대칭 차집합 요소 수++** 또는 **대칭 차집합 요소 수--**

나의 경우, HashSet은 사용했으나 귀찮아서 전부 add하고 공집합 개수를 구한 다음 합집합(=set 요소수)에서 소거

### 제출 일자

2024년 10월 4일 18:35:43
